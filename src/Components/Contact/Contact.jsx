...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "a0460c39-0691-4f6f-9ae2-9f9cfed503ed");
  ...
  return (
    <div className='contact'>
      <div className="contact-col">
        ...
        <p>Feel free to reach out through the contact form or find our contact information
        ...
        <ul>
          ...
          <li><img src={phone_icon} alt="" />+91 1234-1235-95</li>
